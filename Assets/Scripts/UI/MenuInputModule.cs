...
{
    [AddComponentMenu("Event/Menu Input Module")]
    /// <summary>
    /// A BaseInputModule designed for mouse / keyboard / controller input. Deselection is removed. 
    /// </summary>
    /// <remarks>
    ...
    public class MenuInputModule : PointerInputModule
    {
        ...
        [Obsolete("forceModuleActive has been deprecated. There is no need to force the module awake as MenuInputModule works for all platforms")]
